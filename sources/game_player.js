...
function updatePlayersList() {
  ...
  function playerCard(player_index,card_position){
    if (card_position == 'center'){
      ...
      text_player_card_name = createP(players[player_index].player_name).parent('player_card_mid_text').class('text_style_mid');
      text_player_current_case = createP('You are at : '+players[player_index].player_case).parent('player_card_mid_text').class('text_style_mid');
    }
      ...
      text_player_card_name = createP('Current player: '+players[player_index].player_name).parent('player_card_bot_text').class('text_style_bot');
      text_player_current_case = createP('Score : '+players[player_index].player_case).parent('player_card_bot_text').class('text_style_bot');
    }
  };
